...
class App extends Component{
  ...
  constructor(props){
    ...
    this.frases = [
        ...
        'O segredo para o sucesso está na perseverança.',
        'A felicidade está no caminho, não no destino final.',
        ...
        'A gratidão transforma simples momentos em tesouros eternos.' 
    ];
